# -*- coding: utf-8 -*-
#
# Code_TYMPAN documentation build configuration file, created by
...
breathe_projects = { "tympan": "./_static/doxyoutput/xml" }
breathe_default_project = "tympan"
...
project = u'Code_TYMPAN'
copyright = u'2012, EDF-R&D Departement AMA'
...
# of the sidebar.
html_logo = "./_static/images/logo_Code_TYMPAN_200px.png"
...
htmlhelp_basename = 'Code_TYMPANdoc'
...
latex_documents = [
  ('index', 'Code_TYMPAN.tex', u'Code_TYMPAN Documentation',
   u'EDF-R\\&D Departement AMA', 'manual'),
]
...
man_pages = [
    ('index', 'codetympan', u'Code_TYMPAN Documentation',
     [u'EDF-R&D Departement AMA'], 1)
]
...
texinfo_documents = [
  ('index', 'Code_TYMPAN', u'Code_TYMPAN Documentation',
   u'EDF-R&D Departement AMA', 'Code_TYMPAN', 'One line description of project.',
   'Miscellaneous'),
]
