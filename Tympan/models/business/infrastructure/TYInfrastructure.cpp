...
void TYInfrastructure::getAllSrcs(TYTabSourcePonctuelleGeoNode& tab)
{
    assert(false && "Not implemented yet.");
}

void TYInfrastructure::getAllSrcs(const TYCalcul* pCalcul, TYTabSourcePonctuelleGeoNode& tab)
{
    tab.clear();
    unsigned int i, j;
