...
class TYSiteNode: public TYElement
{
    ...
    /**
     * Initialise l'i¿½tat "isInCurrentCalcul" des enfants d'un projet
     */
    ...
    /**
     * Supprime tous les i¿½li¿½ments d'un site du calcul
     */
    ...
    /**
     * Recherche le parent "mi¿½tier" d'un i¿½lement et le met i¿½ jour
     ...
     *
     * @param useEcran Indique si les faces des machines et bi¿½timents doivent
...
protected:
    ...
    /// Nombre de faces de l'infrastructure (machines, bi¿½timents, etc ...)
