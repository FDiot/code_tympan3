...
class TYSiteNode: public TYElement
{
    ...
    /**
     * Initialise l'i申tat "isInCurrentCalcul" des enfants d'un projet
     */
    ...
    /**
     * Supprime tous les i申li申ments d'un site du calcul
     */
    ...
    /**
     * Recherche le parent "mi申tier" d'un i申lement et le met i申 jour
     ...
     *
     * @param useEcran Indique si les faces des machines et bi申timents doivent
...
protected:
    ...
    /// Nombre de faces de l'infrastructure (machines, bi申timents, etc ...)
