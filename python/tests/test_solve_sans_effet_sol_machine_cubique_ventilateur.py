...
class TestSolveSANS_EFFET_SOL_MACHINE_CUBIQUE_VENTILATEUR(TympanTC):
    @unittest.expectedFailure # Regression compared to Code_TYMPAN 3.10
    def test_sans_effet_sol_machine_cubique_ventilateur(self):
        _test_solve_with_file('TEST_SANS_EFFET_SOL_MACHINE_CUBIQUE_VENTILATEUR_NO_RESU.xml', self)
