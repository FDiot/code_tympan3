...
class TestSolveRECEPTEURS_SOL_MACHINE_DANS_BATIMENT_CUBIQUE_AVEC_ECRAN(TympanTC):
    ...
    def test_recepteurs_sol_machine_dans_batiment_cubique_avec_ecran(self):
        _test_solve_with_file('TEST_RECEPTEURS_SOL_MACHINE_DANS_BATIMENT_CUBIQUE_AVEC_ECRAN_NO_RESU.xml', self)
