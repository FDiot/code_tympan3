...
cdef class ProblemModel:
    ...
    @cy.locals(spectrum_values=np.ndarray, directivity=Directivity)
    def _add_source(self, position, spectrum_values, shift, directivity):
        ...
        source_idx = self.thisptr.get().make_source(pos, spec.toGPhy(),
                                                    directivity.thisptr)
        return source_idx
