...
if(MSVC)
  ...
  install(FILES ${NMPB2008_INSTALL_DIR}/RoadEmissionNMPB2008.dll
    DESTINATION . RENAME RoadEmissionNMPB.dll )
else()
  set(filename ${CMAKE_SHARED_LIBRARY_PREFIX}RoadEmissionNMPB2008${CMAKE_SHARED_LIBRARY_SUFFIX})
