...
function( cython_add_module _name )
  ...
  # This is a hack to allow patching the generated file
  cython_patch(OUTPUT patched_file FILE ${generated_file})
  include_directories( ${PYTHON_INCLUDE_DIRS} )
  python_add_module( ${_name} ${patched_file} ${other_module_sources} )
  if( APPLE )
